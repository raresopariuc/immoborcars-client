...
import {addPictureToCar, updateCar} from '../util/APIUtils';
import {API_BASE_URL, ANNOUNCEMENT_TITLE_MAX_LENGTH, ANNOUNCEMENT_PROPERTY_MAX_LENGTH} from '../constants';
import { getCarById, deletePicture } from "../util/APIUtils";
    ...
    loadCar(id) {
        ...
        promise.then(response => {
            this.setState({
                ...
                cubicCapacity: {
                    text: response.cubicCapacity,
                    ...this.validateNumberProperty(response.cubicCapacity)
                },
                power: {
                    text: response.power,
                    ...this.validateNumberProperty(response.power)
                },
                mileage: {
                    text: response.mileage,
                    ...this.validateNumberProperty(response.mileage)
                },
                yearOfManufacture: {
                    text: response.yearOfManufacture,
                    ...this.validateNumberProperty(response.yearOfManufacture)
                },
                fuel: {
                    text: response.fuel,
                    ...this.validateStringProperty(response.fuel)
                },
                gearbox: {
                    text: response.gearbox,
                    ...this.validateStringProperty(response.gearbox)
                },
                emissionClass: {
                    text: response.emissionClass,
                    ...this.validateStringProperty(response.emissionClass)
                },
                vin: {
                    text: response.vin,
                    ...this.validateVinProperty(response.vin)
                },
                isLoading: false
            })
                    ...
                    <Form onSubmit={this.handleSubmit} className="create-car-form">
                        ...
                        <FormItem className="car-form-row">
                            <Button type="primary"
                                    ...
                                    className="create-car-form-button">Update car</Button>
                        </FormItem>
                    </Form>
                </div>
            </div>
