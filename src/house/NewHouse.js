...
import {addPictureToHouse, createHouse} from '../util/APIUtils';
    ...
    render() {
        ...
        return (
            <div className="new-house-container">
                <h1 className="page-title">Add house</h1>
                    ...
                    <Form onSubmit={this.handleSubmit} className="create-house-form">
                        ...
                        <FormItem className="house-form-row">
                            <Button type="primary"
                                    ...
                                    className="create-house-form-button">Add house</Button>
                        </FormItem>
                    </Form>
                </div>
            </div>
