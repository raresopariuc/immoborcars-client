...
import './HouseInputSearch.css';

const InputGroup = Input.Group;
const { Option } = Select;

class HouseInputSearch extends Component {
    ...
    constructor(props) {
        ...
        this.handleGardenSurfaceMinChange = this.handleGardenSurfaceMinChange.bind(this);
        this.handleGardenSurfaceMaxChange = this.handleGardenSurfaceMaxChange.bind(this);
    ...
    handleGardenSurfaceMinChange(event) {
        const value = event.target.value;
        this.setState({
            gardenSurfaceMin: value
        });
    }

    handleGardenSurfaceMaxChange(event) {
        const value = event.target.value;
        this.setState({
            gardenSurfaceMax: value
        });
    }
                    ...
                    <div className="input-search-row">
                        ...
                        <InputGroup className="input-search-filter" compact >
                            <Input
                                ...
                                defaultValue="Garden surface (m²)"
                                disabled />
                            <Input placeholder="Minimum" onChange={this.handleGardenSurfaceMinChange} style={{width: 100, textAlign: 'center'}} />
                            <Input
                                style={{
                                    width: 30,
                                    pointerEvents: 'none',
                                ...
                                placeholder="-"
                                disabled />
                            <Input placeholder="Maximum" onChange={this.handleGardenSurfaceMaxChange} style={{width: 100, textAlign: 'center'}} />
                        </InputGroup>
                    </div>
                    <div className="input-search-row">
                        <InputGroup className="input-search-filter" compact >
...
export default withRouter(HouseInputSearch)